  ...
  return (
    <div className="min-h-screen py-28 sm:py-32 max-w-[1200px] mx-auto px-4 text-left">
      ...
      <p className="sm:text-xl font-medium text-gray-800 dark:text-gray-300 mb-6">
        This website is operated by MayaWebTech ( powered by Webwise Studio ).
        Throughout the site, the terms “we”, “us” and “our” refer to MayaWebTech
        ( powered by MayaWebTech ). MayaWebTech ( powered by Webwise Studio )
      ...
      <p className="sm:text-xl font-medium text-gray-800 mb-6 dark:text-gray-300">
      ...
      <div className="tnc1 my-16">
        ...
        <div className="space-y-2 mb-6 sm:text-lg font-medium text-gray-500 dark:text-gray-300 ">
          <h3>
            <strong> 1.1</strong> &nbsp; By agreeing to these Terms of Service,
            ...
            in your state or province of residence and you have given us your
            consent to allow any of your minor dependents to use this site.
          </h3>
          <h3>
            <strong> 1.2</strong> &nbsp; You may not use our products for any
          ...
          <h3>
            <strong> 1.3</strong> &nbsp; You must not transmit any worms or
            viruses or any code of a destructive nature.
          </h3>
          <h3>
            <strong> 1.4</strong> &nbsp; A breach or violation of any of the
      ...
      <div className="tnc2 my-16">
        ...
        <div className="space-y-2 mb-6 sm:text-lg font-medium text-gray-500 dark:text-gray-300 ">
          <h3>
            <strong> 2.1</strong> &nbsp; We reserve the right to refuse service
            to anyone for any reason at any time.
          </h3>
          <h3>
            <strong> 2.2</strong> &nbsp; You understand that your content (not
            including credit card information), may be transferred unencrypted
            and involve:
            <div className="pl-2 pt-1">
              <h4>
                {" "}
                <strong>a {") "} </strong> &nbsp; Transmissions over various
                networks{" "}
              </h4>
              <h4>
                {" "}
                <strong>b {") "} </strong> &nbsp; Changes to conform and adapt
          ...
          <h3>
            <strong> 2.3</strong> &nbsp; You agree not to reproduce, duplicate,
          ...
          <h3>
            <strong> 2.4</strong> &nbsp; The headings used in this agreement are
      ...
      <div className="tnc3 my-16">
        ...
        <div className="space-y-2 mb-6 sm:text-lg font-medium text-gray-500 dark:text-gray-300 ">
          <h3>
            <strong> 3.1</strong> &nbsp; We are not responsible if information
            made available on this site is not accurate, complete or current.
          ...
          <h3>
            <strong> 3.2</strong> &nbsp; This site may contain certain
      ...
      <div className="tnc4 my-16">
        ...
        <div className="space-y-2 mb-6 sm:text-lg font-medium text-gray-500 dark:text-gray-300 ">
          <h3>
            <strong> 4.1</strong> &nbsp; Prices for our products are subject to
            change without notice.
          </h3>
          <h3>
            <strong> 3.2</strong> &nbsp; We reserve the right at any time to
            modify or discontinue the Service (or any part or content thereof)
            without notice at any time.
          </h3>
          <h3>
            <strong> 3.3</strong> &nbsp; We shall not be liable to you or to any
      ...
      <div className="tnc5 my-16">
        ...
        <div className="space-y-2 mb-6 sm:text-lg font-medium text-gray-500 dark:text-gray-300 ">
          <h3>
            <strong> 5.1</strong> &nbsp; Certain products or services may be
          ...
          <h3>
            <strong> 5.2</strong> &nbsp; We have made every effort to display as
          ...
          <h3>
            <strong> 5.3</strong> &nbsp; We reserve the right, but are not
          ...
          <h3>
            <strong> 5.4</strong> &nbsp; We do not warrant that the quality of
      ...
      <div className="tnc6 my-16">
        ...
        <div className="space-y-2 mb-6 sm:text-lg font-medium text-gray-500 dark:text-gray-300 ">
          <h3>
            <strong> 6.1</strong> &nbsp; We reserve the right to refuse any
          ...
          <h3>
            <strong> 6.2</strong> &nbsp; You agree to provide current, complete
          ...
          <h3>
            <strong> 6.3</strong> &nbsp; For more detail, please review our
            Returns Policy.
          </h3>
        </div>
      </div>
      ...
      <div className="tnc7 my-16">
        ...
        <div className="space-y-2 mb-6 sm:text-lg font-medium text-gray-500 dark:text-gray-300 ">
          <h3>
            <strong> 7.1</strong> &nbsp; We may provide you with access to
            third-party tools over which we neither monitor nor have any control
            nor input.
          </h3>
          <h3>
            <strong> 7.2</strong> &nbsp; You acknowledge and agree that we
          ...
          <h3>
            <strong> 7.3</strong> &nbsp; Any use by you of optional tools
          ...
          <h3>
            <strong> 7.4</strong> &nbsp; We may also, in the future, offer new
      ...
      <div className="tnc8 my-16">
        ...
        <div className="space-y-2 mb-6 sm:text-lg font-medium text-gray-500 dark:text-gray-300 ">
          <h3>
            <strong> 8.1</strong> &nbsp; Certain content, products and services
            available via our Service may include materials from third-parties.
          </h3>
          <h3>
            <strong> 8.2</strong> &nbsp; Third-party links on this site may
          ...
          <h3>
            <strong> 8.3</strong> &nbsp; We are not liable for any harm or
          ...
          <h3>
            <strong> 8.4</strong> &nbsp; We may also, in the future, offer new
            services and/or features through the website (including, the release
            of new tools and resources). Such new features and/or services shall
            also be subject to these Terms of Service.
          </h3>
      ...
      <div className="tnc9 my-16">
        ...
        <div className="space-y-2 mb-6 sm:text-lg font-medium text-gray-500 dark:text-gray-300 ">
          <h3>
            <strong> 9.1</strong> &nbsp; If, at our request, you send certain
            specific submissions (for example contest entries) or without a
            ...
            <div className="pl-2 pt-1">
              <h4>
                {" "}
                <strong>a {") "} </strong> &nbsp; To maintain any comments in
                confidence.
              </h4>
              <h4>
                {" "}
                <strong>b {") "} </strong> &nbsp; To pay compensation for any
                comments.
              </h4>
              <h4>
                {" "}
                <strong>c {") "} </strong> &nbsp; To respond to any comments.
              </h4>
            </div>
          </h3>
          <h3>
            <strong> 9.2</strong> &nbsp; We may, but have no obligation to,
          ...
          <h3>
            <strong> 9.3</strong> &nbsp; You agree that your comments will not
      ...
      <div className="tnc11 my-16">
        ...
        <div className="space-y-2 mb-6 sm:text-lg font-medium text-gray-500 dark:text-gray-300 ">
          <h3>
            <strong> 11.1</strong> &nbsp; Occasionally there may be information
          ...
          <h3>
            <strong> 11.2</strong> &nbsp; We undertake no obligation to update,
      ...
      <div className="tnc12 my-16">
        ...
        <h2 className="text-lg uppercase font-semibold text-gray-600 dark:text-gray-300 pb-3">
          In addition to other prohibitions as set forth in the Terms of
          Service, you are prohibited from using the site or its content:
        </h2>
        <div className="space-y-2 mb-6 sm:text-lg font-medium text-gray-500 dark:text-gray-300 ">
          <h3>
            <strong> 12.1</strong> &nbsp; For any unlawful purpose
          </h3>
          <h3>
            <strong> 12.2</strong> &nbsp; To solicit others to perform or
            participate in any unlawful acts
          </h3>
          <h3>
            <strong> 12.3</strong> &nbsp; To violate any international, federal,
            provincial or state regulations, rules, laws, or local ordinances
          </h3>
          <h3>
            <strong> 12.4</strong> &nbsp; To infringe upon or violate our
            intellectual property rights or the intellectual property rights of
            others
          </h3>
          <h3>
            <strong> 12.5</strong> &nbsp; To harass, abuse, insult, harm,
          ...
          <h3>
            <strong> 12.6</strong> &nbsp; To submit false or misleading
            information
          </h3>
          <h3>
            <strong> 12.7</strong> &nbsp; To upload or transmit viruses or any
          ...
          <h3>
            <strong> 12.8</strong> &nbsp; To collect or track the personal
            information of others.
          </h3>
          <h3>
            <strong> 12.9</strong> &nbsp; To spam, phish, pharm, pretext,
            spider, crawl, or scrape
          </h3>
          <h3>
            <strong> 12.10</strong> &nbsp; For any obscene or immoral purpose
          </h3>
          <h3>
            <strong> 12.11</strong> &nbsp; To interfere with or circumvent the
      ...
      <div className="tnc13 my-16">
        ...
        <div className="space-y-2 mb-6 sm:text-lg font-medium text-gray-500 dark:text-gray-300 ">
          <h3>
            <strong> 13.1</strong> &nbsp; We do not guarantee, represent or
            warrant that your use of our service will be uninterrupted, timely,
            secure or error-free.
          </h3>
          <h3>
            <strong> 13.2</strong> &nbsp; We do not warrant that the results
            that may be obtained from the use of the service will be accurate or
            reliable.
          </h3>
          <h3>
            <strong> 13.3</strong> &nbsp; You agree that from time to time we
            may remove the service for indefinite periods of time or cancel the
            service at any time, without notice to you
          </h3>
          <h3>
            <strong> 13.4</strong> &nbsp; You expressly agree that your use of,
          ...
          <h3>
            <strong> 13.5</strong> &nbsp; In no case shall MayaWebTechs (
            powered by MayaWebTech ), our directors, officers, employees,
      ...
      <div className="tnc14 my-16">
        ...
        <div className="space-y-2 mb-6 sm:text-lg font-medium text-gray-500 dark:text-gray-300 ">
          <h3>
            You agree to indemnify, defend and hold harmless MayaWebTech (
            powered by MayaWebTech ) and our parent, subsidiaries, affiliates,
      ...
      {/* Terms n conditions 15 */}
      <div className="tnc15 my-16">
        <h1 className="uppercase text-xl sm:text-2xl font-semibold after:content-[' '] after:block after:w-6 after:h-1 after:mt-1 after:bg-red-700 mb-6">
          15. SEVERABILITY
        </h1>
      ...
      {/* Terms n conditions 16 */}
      <div className="tnc16 my-16">
        <h1 className="uppercase text-xl sm:text-2xl font-semibold after:content-[' '] after:block after:w-6 after:h-1 after:mt-1 after:bg-red-700 mb-6">
          16. TERMINATION
        </h1>
        ...
        <div className="space-y-2 mb-6 sm:text-lg font-medium text-gray-500 dark:text-gray-300 ">
          <h3>
            <strong> 16.1</strong> &nbsp; The obligations and liabilities of the
            parties incurred prior to the termination date shall survive the
            termination of this agreement for all purposes.
          </h3>
          <h3>
            <strong> 16.2</strong> &nbsp; These Terms of Service are effective
          ...
          <h3>
            <strong> 16.3</strong> &nbsp; If in our sole judgment you fail, or
      ...
      <div className="tnc16 my-16">
        ...
        <div className="space-y-2 mb-6 sm:text-lg font-medium text-gray-500 dark:text-gray-300 ">
          <h3>
            <strong> 17.1</strong> &nbsp; The failure of us to exercise or
            enforce any right or provision of these Terms of Service shall not
            constitute a waiver of such right or provision.
          </h3>
          <h3>
            <strong> 17.2</strong> &nbsp; These Terms of Service and any
          ...
          <h3>
            <strong> 17.3</strong> &nbsp; Any ambiguities in the interpretation
      ...
      {/* Terms n conditions 18 */}
      <div className="tnc18 my-16">
        <h1 className="uppercase text-xl sm:text-2xl font-semibold after:content-[' '] after:block after:w-6 after:h-1 after:mt-1 after:bg-red-700 mb-6">
          18. GOVERNING LAW
        </h1>
        ...
        <div className="space-y-2 mb-6 sm:text-lg font-medium text-gray-500 dark:text-gray-300 ">
          <h3>
            ...
            accordance with the laws of India and jurisdiction of Noida,
            Uttarpradesh
          </h3>
        </div>
      </div>

      {/* Terms n conditions 19 */}
      <div className="tnc19 my-16">
        <h1 className="uppercase text-xl sm:text-2xl font-semibold after:content-[' '] after:block after:w-6 after:h-1 after:mt-1 after:bg-red-700 mb-6">
        ...
        <div className="space-y-2 mb-6 sm:text-lg font-medium text-gray-500 dark:text-gray-300 ">
          <h3>
            <strong> 19.1</strong> &nbsp; You can review the most current
            version of the Terms of Service at any time at this page.
          </h3>
          <h3>
            <strong> 19.2</strong> &nbsp; We reserve the right, at our sole
          ...
          <h3>
            <strong> 19.3</strong> &nbsp; Any ambiguities in the interpretation
            of these Terms of Service shall not be construed against the
            drafting party.
          </h3>
        </div>
      ...
      {/* Terms n conditions contact */}
      <div className="tncContact my-16">
        <h1 className="uppercase text-xl sm:text-2xl font-semibold after:content-[' '] after:block after:w-6 after:h-1 after:mt-1 after:bg-red-700 mb-6">
          20. Contact Information
        </h1>
        <div className="sm:text-lg font-medium text-gray-500 dark:text-gray-300 ">
          If you have any questions about these Terms, please contact us at:
          <h4 className="py-4 text-gray-700 dark:text-gray-300">
